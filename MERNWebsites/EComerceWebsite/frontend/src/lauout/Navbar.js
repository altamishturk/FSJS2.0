      ...
      <div className="flex w-full items-center">
        ...
        <ul className="hidden xl:flex px-4 ml-20 2xl:ml-40 mr-auto">
          ...
          <li className="relative mr-16">
            <a className="flex items-center font-medium hover:text-darkBlueGray-400" href="/">
          ...
          <li><a className="font-medium hover:text-darkBlueGray-400" href="/">Outlet</a></li>
        </ul>
        ...
        <div className="hidden xl:flex items-center">
          ...
          <a className="flex items-center text-darkBlueGray-400 hover:text-darkBlueGray-500" href="/">
            <span className="font-medium">Sona</span>
            <img 
            className="ml-5 w-6 h-6 rounded-full" 
