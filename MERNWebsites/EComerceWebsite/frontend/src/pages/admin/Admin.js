  ...
  return (
    ...
    <div className='flex w-full'>
        ...
        <div className='w-full' >
            <div className="sticky z-10 top-0 left-0 h-16 border-b bg-white lg:py-2.5">
            ...
            <div onClick={()=>setshowSideBar(false)} className="px-6 pt-6 mx-auto 2xl:container bg-brandbg1 h-[91vh] overflow-y-scroll">
                <Outlet/>
            </div>
        </div>
    </div>
