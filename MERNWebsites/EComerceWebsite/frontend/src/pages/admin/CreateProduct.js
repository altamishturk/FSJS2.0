...
function CreateProduct() {
  ...
  return (
    ...
    <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 mt-20">
        <h1 className="text-xl mb-5 font-bold text-brandtext1 text-center capitalize dark:text-white">Create Product</h1>
        <form className='border-t border-brandtext2'>
            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    ...
                    <input id="name" name='name' type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
                </div>
                ...
                <div>
                    ...
                    <input id="quantity" type="number" name='quantity' className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
                </div>
            ...
            <div className="flex justify-end mt-6">
                <button className="w-full px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-brandbg2 rounded-md hover:bg-brandbg2Hover focus:outline-none focus:bg-gray-600">Save</button>
            </div>
        </form>
    </section>
